...
const Details: React.FC<Props> = ({ selectedElement, onClose }) => {
  return (
    <div
      className={`fixed top-60 right-10 h-full w-[380px] p-6 bg-black/80 backdrop-blur-lg text-white shadow-[0_0_30px_rgba(143,230,74,0.5)] rounded-l-2xl z-50 overflow-y-auto transition-transform duration-300`}
    >
      {selectedElement && (
        <>
